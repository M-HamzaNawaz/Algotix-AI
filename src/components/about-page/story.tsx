      ...
      <PageSection>
        <div className="grid gap-14 laptop:grid-cols-2 laptop:items-center laptop:gap-20">
          ...
          <div>
            ...
            <Reveal amount={0.2}>
              <div className="mt-8 inline-flex rounded-control border border-[#E4E4E8] bg-[#F6F6F7] p-1">
                {tabs.map((t) => {
              ...
              <button
                ...
                className="group mt-10 inline-flex items-center gap-3 rounded-control bg-[linear-gradient(315deg,#FF5A01_0%,#FD5901_100%)] px-8 py-4 text-label uppercase text-white shadow-[0_16px_38px_-14px_rgba(254,89,1,0.75)] transition-transform duration-300 hover:-translate-y-0.5"
              >
                Book a call
